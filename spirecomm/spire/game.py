...
class Game:
    ...
    def from_json(cls, json_state, available_commands):
        ...
        game.proceed_available = (
            "proceed" in available_commands or "confirm" in available_commands
        )
        game.cancel_available = (
            "cancel" in available_commands
            or "leave" in available_commands
            or "return" in available_commands
            or "skip" in available_commands
        )
